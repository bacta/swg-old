 ...
 */
public class FloatParamIffLoader implements TemplateBaseIffLoader<FloatParam> {
    private final Logger logger = LoggerFactory.getLogger(getClass().getSimpleName());

    @Override
    public void load(FloatParam param, ChunkReader chunkReader) {
        ...
        switch (id) {
            case 1:
                param.setValue(chunkReader.readFloat());
                break;
            case 2:
                ...
                break;
            case 3:
                param.setValue(chunkReader.readFloat(), chunkReader.readFloat());
                break;
            case 0:
                param.cleanData();
                break;
    ...
    private void loadWeightedListFromIff(FloatParam param, ChunkReader chunkReader) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            load((FloatParam)weightedValue.value, chunkReader);
