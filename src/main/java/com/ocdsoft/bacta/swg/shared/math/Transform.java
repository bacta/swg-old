...
public final class Transform implements ByteBufferWritable {
    ...
    public Vector rotateLocalToParent(final Vector vec) {
        final float x = vec.getX(), y = vec.getY(), z = vec.getZ();
        return new Vector(
    ...
    public Vector rotateTranslateParentToLocal(final Vector vec) {
        final float x = vec.getX() - matrix[0][3];
        final float y = vec.getY() - matrix[1][3];
        final float z = vec.getZ() - matrix[2][3];
    ...
    public List<Vector> rotateTranslateParentToLocal(final List<Vector> source) {
        ...
        for (final Vector vector : source) {
            final float x = vector.getX() - matrix[0][3];
            final float y = vector.getY() - matrix[1][3];
            final float z = vector.getZ() - matrix[2][3];
    ...
    public void setToScale(final Vector scaleFactor) {
        matrix[0][0] = scaleFactor.getX();
        matrix[0][1] = 0.0f;
        matrix[0][2] = 0.0f;
        matrix[0][3] = 0.0f;

        matrix[1][0] = 0.0f;
        matrix[1][1] = scaleFactor.getY();
        matrix[1][2] = 0.0f;
        matrix[1][3] = 0.0f;

        matrix[2][0] = 0.0f;
        matrix[2][1] = 0.0f;
        matrix[2][2] = scaleFactor.getZ();
        matrix[2][3] = 0.0f;
    }
